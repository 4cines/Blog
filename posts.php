                ...
                <div class= "col-10 mx-auto">
                    <div class="card mb-3">
                        ...
                        <p class="card-text-post fst-italic lh-sm"><small class="text-muted"><?php echo $post_contents['category_name']; ?></small></p>
                            ...
                            <p class="card-text-post fst-italic lh-sm"><small class="text-muted">Autora: <?php echo $post_contents['username']; ?> <?php echo $post_contents['surname']; ?></small></p>
                            <h2 class="card-title fw-bold text-center"><?php echo $post_contents['title']; ?></h2>
                            <p class="card-text text-center"><?php echo $post_contents['content']; ?></p>
                        </div>
                    </div>    
                </div>
            </div>
